...
const TermsofUse = memo(() => {
  useBreadcrumb('Terms & Conditions');
  return (
    <Fragment>
      <div className="section-padding">
        <Container>
          <div className="title-box">
            ...
            <p>
              These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding agreement by and between CHATPATAMOVIES, ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, "Services").
            </p>
            <p>
